    ...
    // 'dist' फ़ोल्डर अब सीधे प्रोजेक्ट रूट में है
    // सुनिश्चित करें कि यह आपके API राउट्स से पहले आता है
    app.use(express.static(path.join(__dirname, '..', 'dist'))); // <--- यह लाइन बदलें
    ...
    app.get('*', (req, res) => {
      res.sendFile(path.resolve(__dirname, '..', 'dist', 'index.html')); // <--- यह लाइन बदलें
    });
